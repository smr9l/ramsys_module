...
((SELECT id FROM ref_role WHERE code = 'ADMIN'), (SELECT id FROM ref_function WHERE code = 'MNT_CTR'), 'system'),
...
INSERT INTO ref_group (code, name, name_fr, name_en, name_ar, created_by) VALUES
('UWR_MGT', 'Souscription', 'Souscription', 'Underwriting', 'الاكتتاب', 'admin'),
('PRM_ACC', 'Prime & Compte Technique', 'Prime & Compte Technique', 'Premium & Technical Account', 'القسط والحساب التقني', 'admin'),
...
INSERT INTO ref_region (code, name, name_fr, name_en, name_ar, created_by) VALUES
('N/A', 'N/A', 'N/A', 'N/A', 'غير محدد', 'system'),
('CIMA', 'CIMA', 'CIMA', 'CIMA', 'سيما', 'system'),
('HCANG', 'Hors CIMA Anglophone', 'Hors CIMA Anglophone', 'Non-CIMA English Speaking', 'خارج سيما الناطقة بالإنجليزية', 'system'),
('HCFRA', 'Hors CIMA Francophone', 'Hors CIMA Francophone', 'Non-CIMA French Speaking', 'خارج سيما الناطقة بالفرنسية', 'system'),
...
('NN', 'N/A', 'N/A', 'N/A', 'غير محدد', (SELECT id FROM ref_region WHERE code = 'N/A'), 'system'),
-- Pays CIMA (11 pays)
('BJ', 'Bénin', 'Bénin', 'Benin', 'بنين', (SELECT id FROM ref_region WHERE code = 'CIMA'), 'system'),
('BF', 'Burkina Faso', 'Burkina Faso', 'Burkina Faso', 'بوركينا فاسو', (SELECT id FROM ref_region WHERE code = 'CIMA'), 'system'),
('CM', 'Cameroun', 'Cameroun', 'Cameroon', 'الكاميرون', (SELECT id FROM ref_region WHERE code = 'CIMA'), 'system'),
('CF', 'République centrafricaine', 'République centrafricaine', 'Central African Republic', 'جمهورية أفريقيا الوسطى', (SELECT id FROM ref_region WHERE code = 'CIMA'), 'system'),
...
('CI', 'Côte d''Ivoire', 'Côte d''Ivoire', 'Ivory Coast', 'ساحل العاج', (SELECT id FROM ref_region WHERE code = 'CIMA'), 'system'),
...
('MR', 'Mauritanie', 'Mauritanie', 'Mauritania', 'موريتانيا', (SELECT id FROM ref_region WHERE code = 'HCFRA'), 'system'),
('CD', 'République démocratique du Congo', 'République démocratique du Congo', 'Democratic Republic of Congo', 'جمهورية الكونغو الديمقراطية', (SELECT id FROM ref_region WHERE code = 'HCFRA'), 'system'),
...
('CV', 'Cap-Vert', 'Cap-Vert', 'Cape Verde', 'الرأس الأخضر', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
...
('GQ', 'Guinée équatoriale', 'Guinée équatoriale', 'Equatorial Guinea', 'غينيا الاستوائية', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
...
('GW', 'Guinée-Bissau', 'Guinée-Bissau', 'Guinea-Bissau', 'غينيا بيساو', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('KE', 'Kenya', 'Kenya', 'Kenya', 'كينيا', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('MG', 'Madagascar', 'Madagascar', 'Madagascar', 'مدغشقر', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('MW', 'Malawi', 'Malawi', 'Malawi', 'ملاوي', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('MZ', 'Mozambique', 'Mozambique', 'Mozambique', 'موزمبيق', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
...
('SL', 'Sierra Leone', 'Sierra Leone', 'Sierra Leone', 'سيراليون', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('SO', 'Somalie', 'Somalie', 'Somalia', 'الصومال', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('ZA', 'Afrique du Sud', 'Afrique du Sud', 'South Africa', 'جنوب أفريقيا', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('SS', 'Soudan du Sud', 'Soudan du Sud', 'South Sudan', 'جنوب السودان', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
...
('CZ', 'République tchèque', 'République tchèque', 'Czech Republic', 'التشيك', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
...
('GB', 'Royaume-Uni', 'Royaume-Uni', 'United Kingdom', 'المملكة المتحدة', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
...
('LU', 'Luxembourg', 'Luxembourg', 'Luxembourg', 'لوكسمبورغ', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('MC', 'Monaco', 'Monaco', 'Monaco', 'موناكو', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('NL', 'Pays-Bas', 'Pays-Bas', 'Netherlands', 'هولندا', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
...
('SK', 'Slovaquie', 'Slovaquie', 'Slovakia', 'سلوفاكيا', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
...
('SA', 'Arabie saoudite', 'Arabie saoudite', 'Saudi Arabia', 'السعودية', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('SY', 'Syrie', 'Syrie', 'Syria', 'سوريا', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('AE', 'Émirats arabes unis', 'Émirats arabes unis', 'United Arab Emirates', 'الإمارات العربية المتحدة', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('YE', 'Yémen', 'Yémen', 'Yemen', 'اليمن', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
-- Asie
('AF', 'Afghanistan', 'Afghanistan', 'Afghanistan', 'أفغانستان', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('AZ', 'Azerbaïdjan', 'Azerbaïdjan', 'Azerbaijan', 'أذربيجان', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('BD', 'Bangladesh', 'Bangladesh', 'Bangladesh', 'بنغلاديش', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('CN', 'Chine', 'Chine', 'China', 'الصين', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('HK', 'Hong Kong', 'Hong Kong', 'Hong Kong', 'هونغ كونغ', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('IN', 'Inde', 'Inde', 'India', 'الهند', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('ID', 'Indonésie', 'Indonésie', 'Indonesia', 'إندونيسيا', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
...
('KR', 'Corée du Sud', 'Corée du Sud', 'South Korea', 'كوريا الجنوبية', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('MY', 'Malaisie', 'Malaisie', 'Malaysia', 'ماليزيا', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('PH', 'Philippines', 'Philippines', 'Philippines', 'الفلبين', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('SG', 'Singapour', 'Singapour', 'Singapore', 'سنغافورة', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('LK', 'Sri Lanka', 'Sri Lanka', 'Sri Lanka', 'سريلانكا', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('TW', 'Taiwan', 'Taiwan', 'Taiwan', 'تايوان', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('TJ', 'Tajikistan', 'Tajikistan', 'Tajikistan', 'طاجيكستان', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('TH', 'Thaïlande', 'Thaïlande', 'Thailand', 'تايلاند', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('TR', 'Turquie', 'Turquie', 'Turkey', 'تركيا', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('TM', 'Turkmenistan', 'Turkmenistan', 'Turkmenistan', 'تركمانستان', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('UZ', 'Uzbekistan', 'Uzbekistan', 'Uzbekistan', 'أوزبكستان', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
...
('AG', 'Antigua-et-Barbuda', 'Antigua-et-Barbuda', 'Antigua and Barbuda', 'أنتيغوا وبربودا', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('AR', 'Argentine', 'Argentine', 'Argentina', 'الأرجنتين', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('AM', 'Arménie', 'Arménie', 'Armenia', 'أرمينيا', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('AU', 'Australie', 'Australie', 'Australia', 'أستراليا', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
...
('BN', 'Brunei Darussalam', 'Brunei Darussalam', 'Brunei', 'بروناي', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
...
('CR', 'Costa Rica', 'Costa Rica', 'Costa Rica', 'كوستاريكا', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
...
('GT', 'Guatemala', 'Guatemala', 'Guatemala', 'غواتيمالا', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
...
('ME', 'Montenegro', 'Montenegro', 'Montenegro', 'الجبل الأسود', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
...
('AN', 'Antilles néerlandaises', 'Antilles néerlandaises', 'Netherlands Antilles', 'الأنتيل الهولندية', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('NZ', 'Nouvelle-Zélande', 'Nouvelle-Zélande', 'New Zealand', 'نيوزيلندا', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('NI', 'Nicaragua', 'Nicaragua', 'Nicaragua', 'نيكاراغوا', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
...
('PR', 'Puerto Rico', 'Puerto Rico', 'Puerto Rico', 'بورتوريكو', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('RE', 'La Réunion', 'La Réunion', 'Reunion', 'ريونيون', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('VC', 'Saint Vincent & Grenadines', 'Saint Vincent & Grenadines', 'Saint Vincent and the Grenadines', 'سانت فنسنت والغرينادين', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('SM', 'San Marino', 'San Marino', 'San Marino', 'سان مارينو', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('ST', 'Sao Tomé-et-Principe', 'Sao Tomé-et-Principe', 'Sao Tome and Principe', 'ساو تومي وبرينسيبي', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('SC', 'Seychelles', 'Seychelles', 'Seychelles', 'سيشل', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
...
('US', 'États-Unis', 'États-Unis', 'United States', 'الولايات المتحدة', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
('VE', 'Venezuela', 'Venezuela', 'Venezuela', 'فنزويلا', (SELECT id FROM ref_region WHERE code = 'AUT'), 'system'),
-- Zones spéciales (2 pays)
('W0', 'Monde Entier', 'Monde Entier', 'Worldwide', 'العالم كله', (SELECT id FROM ref_region WHERE code = 'WW'), 'system'),
('W1', 'Monde Entier sauf États-Unis', 'Monde Entier sauf États-Unis', 'Worldwide except USA', 'العالم كله عدا الولايات المتحدة', (SELECT id FROM ref_region WHERE code = 'WW'), 'system'),
...
('ABD', 'Abidjan', 'Abidjan', 'Abidjan', 'أبيدجان', (SELECT id FROM ref_country WHERE code = 'CI'), 'system'),
('OUA', 'Ouagadougou', 'Ouagadougou', 'Ouagadougou', 'واغادوغو', (SELECT id FROM ref_country WHERE code = 'BF'), 'system'),
...
('CAS', 'Casablanca', 'Casablanca', 'Casablanca', 'الدار البيضاء', (SELECT id FROM ref_country WHERE code = 'MA'), 'system');

-- Insert basic currency
INSERT INTO ref_currency (code, name, name_fr, name_en, name_ar, is_active, created_by) VALUES
('XOF', 'Franc CFA (BCEAO)', 'Franc CFA (BCEAO)', 'CFA Franc (BCEAO)', 'فرنك أفريقيا الوسطى (بسياو)', true, 'system'),
('XAF', 'Franc CFA (BEAC)', 'Franc CFA (BEAC)', 'CFA Franc (BEAC)', 'فرنك أفريقيا الوسطى (بياك)', true, 'system'),
...
('MRU', 'Ouguiya mauritanienne', 'Ouguiya mauritanienne', 'Mauritanian Ouguiya', 'أوقية موريتانية', true, 'system'),
...
('CEDANT', 'Cédant', 'Cédant', 'Cedant', 'المتنازل', 'system'),
('BROKER', 'Courtier', 'Courtier', 'Broker', 'وسيط', 'system'),
('OTHER', 'Autre', 'Autre', 'Other', 'أخرى', 'system');

-- Insert rating data
INSERT INTO ref_rating (code, name, name_fr, name_en, name_ar, description, numeric_value, created_by) VALUES
('N/A', 'Non évalué', 'Non évalué', 'Not Rated', 'غير مقيم', 'Non évalué', 0, 'system'),
...
INSERT INTO ref_location (code, name, partner_id, city_id, reporting_currency_id, starting_year, current_period_id, locale, decimal_places, percentage_decimal_places, settlement_tolerance, uncovered_tolerance, is_factoring_enabled, default_bank_account, created_by) VALUES
('L1', 'Siège Abidjan',
