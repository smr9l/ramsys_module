...
(
    ...
    factoring_ind             BOOLEAN            NOT NULL DEFAULT FALSE,
...
(
    ...
    location_id              BIGINT REFERENCES ref_location (id),
    division_id              BIGINT REFERENCES ref_division (id),
...
(
    ...
    -- Risk Profile
    occupancy_id        BIGINT                   NOT NULL REFERENCES ref_occupancy (id),
    ...
    -- Address Info (similar to partner)
    address             TEXT,
    area                VARCHAR(40),
    road                VARCHAR(40),
    building            VARCHAR(40),
    ...
    -- Contact Info (similar to partner)
    contact_genre       VARCHAR(5),
    contact_name        VARCHAR(40),
    telephone           VARCHAR(20),
    fax                 VARCHAR(20),
    email_prefix        VARCHAR(40),
    email_domain        VARCHAR(40),

    partner_id          BIGINT REFERENCES ref_partner (id),
...
CREATE INDEX idx_ref_insured_occupancy ON ref_insured (occupancy_id);
CREATE INDEX idx_ref_insured_location ON ref_insured (country_id, region_id, city_id);
CREATE INDEX idx_ref_insured_partner ON ref_insured (partner_id);