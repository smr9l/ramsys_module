...
INSERT INTO ref_period (year, month, name, start_date, end_date, is_current_processing, is_open_for_linkage,
                        is_open_for_exchange_rates, is_open_for_bank_balance, created_by)
VALUES
-- 2024 periods
...
--changeset system:13-insert-all-users-data
--comment: Insertion de tous les utilisateurs depuis R1
...
INSERT INTO ref_user_detail (username, password_hash, first_name, last_name, email, title, role_id, location_id,
                             created_by)
VALUES ('ROL', '$2a$10$YZiRBJdGkAA.hash', 'Roland', 'OUEDRAOGO', 'roland.ouedraogo@sunu-group.com', 'Directeur General',
...
--changeset system:9-insert-group-function-mappings
--comment: Insert group-function mappings from R1
...
--changeset system:10-insert-role-group-mappings
--comment: Insert role-group mappings from R1
-- Admin role gets all groups
